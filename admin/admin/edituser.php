...
mysqli_query($con,"update user_info set first_name=?, last_name=?, email= ?, password= ? where user_id=?")or die("Query 2 is inncorrect..........");
$stmt = $conn->prepare($sql); 
$stmt->bind_param("sssss",$first_name,$last_name,$email,$user_password,$user_id);
$stmt->execute();
