...
/*this is delet query*/
mysqli_query($con,"delete from orders where order_id= ?")or die("delete query is incorrect...");
          ...
          <div class="col-md-14">
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">Activity  / Page <?php htmlspecialchars(echo $page);?> </h4>
              </div>
              <div class="card-body">
